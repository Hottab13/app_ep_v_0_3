...
export function* hendlerUserData() {
...
export function* hendlerNewEvent() {
  ...
  try {
    ...
    ); // надо сделать сообщение успешного создания
    if (res.status === 200) {
      debugger;
