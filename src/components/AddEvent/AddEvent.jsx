...
import {
  ...
  ASelect,
  Option,
} from "../../utils/makeField";
import { createField, createFieldSelect } from "../../utils/createFields";
import { Form, Button, PageHeader, Alert } from "antd";
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} style={{ paddingTop: "16px" }}>
        ...
        />
        <PicturesWall uploadPhoto={uploadPhoto} />

        <FormItem {...tailFormItemLayout}>
          {err ? (
            <Alert message={"Ошибка: " + message} type="error" />
          ) : success ? (
            <Alert
              message={"Событие успешно создано: " + message}
              type="success"
            />
          ) : (
            ""
